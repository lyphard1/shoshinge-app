...
const originalPagesData = [
  ...
  // --- 念仏和讃 (wasan) ---
  { section: 'wasan', verses: [{ start: 3.9, end: 12, text: '南無阿弥陀仏', ruby: 'なもあみだーんぶ' }, { start: 12, end: 21.4, text: '南無阿弥陀仏', ruby: 'なもあみだーんぶ' }, { start: 21.4, end: 29.7, text: '南無阿弥陀仏', ruby: 'なもあみだーんぶ' }, { start: 29.7, end: 37.7, text: '南', ruby: 'な' }] },
