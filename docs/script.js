...
const originalPagesData = [
  ...
  // --- 正信偈 (shoshinge) ---
  { section: 'shoshinge', verses: [{ start: 45.772861, end: 52.172803, text: '覩見諸仏浄土因', ruby: 'とけんしょぶつじょうどいん' }, { start: 52.821646, end: 59.053149, text: '国土人天之善悪', ruby: 'こくどにんでんしぜんまく' }, { start: 59.053149, end: 59.693473, text: '建立無上殊勝願', ruby: 'こんりゅうむじょうしゅしょうがん' }, { start: 59.693473, end: 65.916459, text: '超発希有大弘誓', ruby: 'ちょうほつけーうだいぐぜい' }] },
  // --- 正信偈 (shoshinge) ---
  ...
  // --- 正信偈 (shoshinge) ---
  { section: 'shoshinge', verses: [{ start: 428.825643, end: 434.230515, text: '広由本願力回向', ruby: 'こうゆほんがんりきえこう' }, { start: 434.842178, end: 440.201873, text: '為度群生彰一心', ruby: 'いどぐんじょうしょういっしん' }, { start: 440.740743, end: 446.228266, text: '帰入功徳大宝海', ruby: 'きにゅうくどくだいほうかい' }, { start: 446.845757, end: 452.447283, text: '必獲入大会衆数', ruby: 'ひっぎゃくにゅうだいえしゅしゅう' }] },
  // --- 正信偈 (shoshinge) ---
