...
const originalPagesData = [
  ...
  // --- 正信偈 (shoshinge) ---
  { section: 'shoshinge', verses: [{ start: 377.154217, end: 382.469577, text: '憶念弥陀仏本願', ruby: 'おくねんみだぶつほんがん' }, { start: 383.14126, end: 388.771148, text: '自然即時入必定', ruby: 'じねんそくじにゅうひつじょう' }, { start: 389.275767, end: 397.796979, text: '唯能常称如来号', ruby: 'ゆいのうじょうしょうにょらいごう' }, { start: 398.359557, end: 403.878407, text: '応報大悲弘誓恩', ruby: 'おうほうだいひぐぜいがん' }] },
  // --- 正信偈 (shoshinge) ---
  ...
  // --- 正信偈 (shoshinge) ---
  { section: 'shoshinge', verses: [{ start: 500.99458, end: 506.464679, text: '天親菩薩論註解', ruby: 'てんじんぼつさろんちゅうげ' }, { start: 507.011116, end: 512.463554, text: '報土因果顕誓願', ruby: 'ほうどいんがけんせいがん' }, { start: 513.027651, end: 518.407394, text: '往還回向由他力', ruby: 'おうげんねこうゆたりき' }, { start: 518.926216, end: 524.433787, text: '正定之因唯信心', ruby: 'しょうじょうしいんゆいしんじん' }] },
  // --- 正信偈 (shoshinge) ---
  ...
  // --- 念仏和讃 (wasan) ---
  { section: 'wasan', verses: [{ start: 643.350046, end: 660.171457, text: '佛光照曜最第一', ruby: 'ぶっこうしょうようさいだいいち' }, { start: 660.171457, end: 675.424479, text: '光炎王仏となづけたり', ruby: 'こうえんのうぶつとなづけたり' }, { start: 675.87259, end: 689.436577, text: '三塗の黒闇ひらくなり', ruby: 'さんとぬくろやみひらくなり' }, { start: 689.988098, end: 702.345631, text: '大応供を帰命せよ', ruby: 'だいおうぐをきみょうせよ' }] },
  // --- 念仏和讃 (wasan) ---
